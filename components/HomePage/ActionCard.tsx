...
const ActionCard: FunctionComponent<Props> = ({ hero_content, goto, description, button_title }) => {
    return (
        <Link
            href={goto}
            className="w-[1000px] rounded-xl bg-slate-200 hover:bg-primary-400 h-[250px] text-gray-800 hover:text-white  flex gap-8 flex-col px-6 py-6 font-primary_noto cursor-pointer"
        >
